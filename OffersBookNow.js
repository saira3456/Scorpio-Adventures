...
function saveFormData() {
    const formData = {
        ...
        totalPrice: localStorage.getItem('totalPrice'), // Assuming totalPrice is already set elsewhere
        discountedPrice: localStorage.getItem('discountedPrice'), // Assuming discountedPrice is already set elsewhere
        countryName: localStorage.getItem('countryName'), // Assuming countryName is already set elsewhere
        hotelName: localStorage.getItem('hotelName'), // Assuming hotelName is already set elsewhere
        restaurantName: localStorage.getItem('restaurantName') // Assuming restaurantName is already set elsewhere
    };
...
function printTicket() {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let discountedPrice = localStorage.getItem('discountedPrice');
        ...
        // Print ticket using the retrieved data
        document.getElementById('total-price').innerText = `Total Price: ₨${totalPrice}`;
        document.getElementById('discounted-price').innerText = `Discounted Price: ₨${discountedPrice}`;
        document.getElementById('country-name').innerText = `Country: ${countryName}`;
        document.getElementById('hotel-name').innerText = `Hotel: ${hotelName}`;
        document.getElementById('restaurant-name').innerText = `Restaurant: ${restaurantName}`;
    });
    ...
    newWindow.document.write(`
        ...
        <head>
            ...
            @media print {
                ...
                .logo img {
                    height: 100%; /* Set the height of the logo to match the height of the text */
                }
            }
            body {
                margin: 0;
        ...
        <body>
            <div class="headder">
                <div class="logo">
                    <img src="../asserts/Green and Blue Playful Illustrated World Travel Logo.png" alt="logo" width="60px">
                </div>
            ...
            <div class="bookings printable">
                ...
                <div class="booking">
                    ...
                    <div class="form-group">
                        ...
                        <p>${localStorage.getItem('discountedPrice')}</p>
                    </div>
                    <div class="form-group">
                        <label for="country-name">Country:</label>
                        <p>${localStorage.getItem('countryName')}</p>
                    </div>
                    <div class="form-group">
                        <label for="hotel-name">Hotel:</label>
                        <p>${localStorage.getItem('hotelName')}</p>
                    </div>
                    <div class="form-group">
